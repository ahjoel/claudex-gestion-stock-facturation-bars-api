...
module.exports = function (app) {
    ...
    app.get("/claudex_bars/v1/codefacture", [authController.verifyToken], mouvementEntreeR1Handler.findCodeFactureR1);
    ...
    app.get("/claudex_bars/v1/codefacture", [authController.verifyToken], mouvementEntreeRCHandler.findCodeFactureRc);
